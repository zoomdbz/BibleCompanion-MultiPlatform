...
«Disse Deus: 'Haja luminares na expansão dos céus, para separar o dia da noite. E sejam por **sinais** e para **estações** e para dias e anos'» (Gênesis 1:14).

A palavra hebraica para «sinais» é *otot*, a mesma palavra usada para os sinais que Deus deu a Moisés (Êxodo 4:8–9). A palavra para «estações» é *moadim*, as festas designadas. Deus projetou os corpos celestes como marcadores do Seu calendário profético.

---

## Luas de Sangue e Eclipses Lunares
...
Uma tétrade é composta por quatro eclipses lunares totais consecutivos, cada um separado por aproximadamente seis meses. Várias tétrades coincidiram exatamente com a Páscoa e Sucot. A janela de 2024–2026 adiciona um novo padrão: um eclipse solar total na véspera de Nisã 1, um eclipse solar anular em Rosh Hashanah, e luas de sangue de Purim consecutivas. Após um período tranquilo de 2027–2031 sem alinhamentos de festas, 2032 produz uma lua de sangue em Pesach Sheni, e 2033 concentra quatro eclipses alinhados a festas em um único ano: um eclipse solar total na véspera de Nisã 1, uma lua de sangue de Páscoa, um eclipse solar parcial na véspera de Rosh Hashanah, e uma lua de sangue de Sucot.
...
| 2025 | Lunar total (lua de sangue) | Primeira de duas luas de sangue consecutivas de Purim | Purim (14 de mar, 14 de Adar 5785) |
| 2026 | Lunar total (lua de sangue) | Segunda lua de sangue consecutiva de Purim | Purim (3 de mar, 14 de Adar 5786) |
...
As tétrades históricas coincidem com grandes pontos de virada na história judaica. O agrupamento de 2024–2033 não forma uma tétrade, mas contém as primeiras luas de sangue em dias de festa desde 2015 e concentra quatro eclipses alinhados a festas apenas em 2033. Se esses alinhamentos têm peso profético é uma questão de interpretação; os eventos astronômicos em si são fatos documentados.
...
Os magos viram «a sua estrela» (Mateus 2:2). Vários eventos astronômicos por volta de 3–2 a.C. foram propostos:

- **Tripla conjunção Júpiter-Régulo** (3–2 a.C.): Júpiter (o «planeta rei») passou pela estrela Régulo (do latim «pequeno rei») na constelação de Leão (o leão = Judá) três vezes devido ao movimento retrógrado
...
## As Trevas na Crucificação

«Desde a hora sexta houve trevas sobre toda a terra até a hora nona» (Mateus 27:45; Marcos 15:33; Lucas 23:44–45).

Isto não foi um eclipse solar; a Páscoa cai na lua cheia, quando eclipses solares são astronomicamente impossíveis. As trevas foram sobrenaturais. Contudo, o historiador do século II Talo (citado por Júlio Africano) tentou explicá-las como um eclipse solar, inadvertidamente confirmando que as trevas foram um evento histórico amplamente conhecido.

Amós 8:9: «Naquele dia, diz o Senhor DEUS, farei que o sol se ponha ao meio-dia e cobrirei a terra de trevas em pleno dia.»

---

## O Sinal de Apocalipse 12
...
Esta configuração completa exata (sol, lua, coroa de 12 objetos e a saída de Júpiter após 42 semanas) é astronomicamente única na história registrada quando todos os parâmetros são considerados juntos. Se cumpre Apocalipse 12:1–2 é uma questão de interpretação, mas o alinhamento astronômico é factual e verificável usando software como o Stellarium.
...
A palavra hebraica *moadim* conecta os corpos celestes diretamente aos tempos designados de Deus:

- A Páscoa sempre ocorre na **lua cheia** (Nisã 14–15)
- Sukkot sempre ocorre na **lua cheia** (Tishrei 15)
- A Festa das Trombetas depende do avistamento da **lua nova** (Tishrei 1)
- O equinócio da primavera determina o início do ano bíblico

Os céus não são adorados (Deuteronômio 4:19), mas são lidos; eles declaram a glória de Deus (Salmo 19:1) e marcam os Seus tempos designados.

---

## 2024–2026: Um Aglomerado de Sinais Celestes

Uma concentração incomum de eclipses alinhados com os dias festivos hebraicos ocorreu ao longo de 2024–2026. As datas abaixo são verificadas pelo catálogo de eclipses da NASA e pelo calendário hebraico Hebcal.

### Luas de Sangue em Purim

Eclipses lunares totais (luas de sangue) ocorreram em **Purim**, o 14º de Adar, em dois anos consecutivos:
...
Este período não produz um tétrade (quatro eclipses lunares totais consecutivos na Páscoa e Sukkot, o último foi 2014–2015). O que 2024–2026 apresenta é um padrão distinto: um eclipse solar em Rosh Hashanah, duas luas de sangue consecutivas de Purim, e uma tempestade solar extraordinária precedendo a segunda.
