...
다음 저작들은 이 앱의 학습 노트와 각 권 서론의 출처로 제시된 것입니다. 여기에는 고대 일차 문헌, 교부들의 증언, 후대의 교회 전통, 비평판, 학술 연구, 주석, 그리고 변증적 저작이 포함됩니다. 이 범주들이 지니는 역사적 비중은 서로 같지 않습니다. 각 학습 노트는 실제로 사용한 정확한 책, 장, 절 또는 쪽을 명시해야 합니다.

**링크 참고:** 출판사 및 도서관 링크는 인용된 판본을 가리킵니다. “무료 텍스트” 링크는 인용에 명시된 정확한 저작권 보호 판본이 아니라 더 오래된 퍼블릭 도메인 번역을 제공하기도 합니다.
