...
以下の著作は、本アプリの学習ノートおよび各書の序説の典拠として挙げられているものです。これらには、古代の一次資料、教父の証言、後代の教会伝承、批判校訂版、学術研究、注解、および護教論的著作が含まれます。これらの範疇が持つ歴史的な重みは同等ではありません。各学習ノートには、実際に用いた書物・章・節または頁を正確に明記すべきです。

**リンクに関する注記:** 出版社および図書館へのリンクは、引用された版を示します。「無料テキスト」リンクは、引用で挙げられた著作権保護下の正確な版ではなく、より古いパブリックドメインの翻訳を提供する場合があります。
